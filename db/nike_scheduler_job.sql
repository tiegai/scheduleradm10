...
INSERT INTO `xxl_job_info` (`id`,`id_group`,`job_group`,`job_desc`,`add_time`,`update_time`,`author`,`alarm_email`,`schedule_type`,`schedule_conf`,`misfire_strategy`,`executor_route_strategy`,`executor_handler`,`executor_param`,`executor_block_strategy`,`executor_timeout`,`executor_fail_retry_count`,`glue_type`,`glue_source`,`glue_remark`,`glue_updatetime`,`child_jobid`,`trigger_status`,`trigger_last_time`,`trigger_next_time`,`trigger_start_time`,`trigger_end_time`) VALUES (2,0,1,'关闭-所有到期任务','2022-11-09 16:51:54','2022-11-09 16:52:40','jerry','','CRON','* * * * * ?','DO_NOTHING','FIRST','basicHttpJobHandler','url:http://127.0.0.1:8080/ncp-scheduler-admin/jobinfo/autoStopJobs\r\nmethod:GET\r\n','SERIAL_EXECUTION',0,0,'BEAN','','GLUE代码初始化','2022-11-09 16:51:54','',1,1669975559000,1669975560000,NULL,NULL);
